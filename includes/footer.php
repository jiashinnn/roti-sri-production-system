...
{               ?>
      ...
      <div class="col-md-3 footer-right">
        <h3>YSLProduction</h3>
        <p>This Online Production System in PHP and MySQL, allows you to easily manage recipe, schedule production, and track batch, all in a simple and effective way. </p>
      </div>
